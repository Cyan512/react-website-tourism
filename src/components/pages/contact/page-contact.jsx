...
import {
    ...
    Anchor, Camera, Tent, Plane, User, ChevronDown, MessageSquare, Play
} from 'lucide-react';
        ...
        <>
            <section>
                <ContainerLayout>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                        ...
                        {/* Address */}
                        <div
                            className="h-full bg-white p-6 md:p-8 rounded-xl border border-gray-100 flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
                            <div
            ...
            <main>
                <section className="relative w-full min-h-[600px] flex items-center py-20 overflow-hidden"
                    ...
                    <div
                        className="relative z-10 max-w-7xl mx-auto px-4 w-full flex flex-col md:flex-row items-center justify-between gap-12">
                        <div className="bg-white p-8 md:p-10 rounded-2xl shadow-2xl w-full max-w-lg">
                            ...
                            <form className="space-y-4">
                                ...
                                <div className="relative">
                                    <select
                                        className="w-full border border-gray-200 rounded-lg py-4 px-5 pr-12 outline-none focus:border-primary transition-colors text-sm text-gray-500 appearance-none bg-white cursor-pointer"
                                    >
                        ...
                        <div className="flex-grow hidden md:flex justify-center items-center ">
                            <button className="relative group">
                                <div
                                    className="absolute inset-0 bg-white/30 rounded-full animate-ping scale-150 duration-[2000ms]"></div>
                                <div
                                    className="absolute inset-0 bg-white/20 rounded-full animate-ping scale-125 duration-[1500ms]"></div>
                                <div
                                    className="relative w-24 h-24 md:w-32 md:h-32 bg-white/20 backdrop-blur-md border border-white/30 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300">
